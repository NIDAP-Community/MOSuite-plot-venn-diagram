test_that("main.R CLI creates venn diagram outputs", {
  setup <- setup_cli_workspace("mosuite_plot_venn_diagram_test_")
...
test_that("run wrapper executes and creates venn diagram outputs", {
  setup <- setup_cli_workspace("mosuite_plot_venn_diagram_run_test_")
  on.exit(unlink(setup$workspace, recursive = TRUE), add = TRUE)
